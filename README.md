...
<br />
<p align="center">
  <a href="https://github.com/rawdatalab/ha-nyc311/commits/master"><img src="https://img.shields.io/github/commit-activity/y/rawdatalab/ha-nyc311.svg" /></a>
  <a href="https://github.com/rawdatalab/ha-nyc311/releases"><img src="https://img.shields.io/github/release/rawdatalab/ha-nyc311.svg" /></a>
  <a href="https://github.com/rawdatalab/ha-nyc311/blob/main/LICENSE"><img alt="GitHub" src="https://img.shields.io/github/license/rawdatalab/ha-nyc311"></a>
</p>
...
2. Add repository: `https://github.com/rawdatalab/ha-nyc311`
3. Category: `Integration`
4. Click "Add"
5. Find "NYC 311 Public Services Calendar" in HACS and install
6. Restart Home Assistant

### Manual Installation

Copy the `custom_components/nyc311` folder to your Home Assistant `config/custom_components/` directory.

## Recent Updates

- Fixed calendar event formatting compatibility with HA 2024+
- Updated API error handling
- Dependency updates for current Python versions
